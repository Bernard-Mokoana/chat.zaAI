...
class TestAuthRoutes:
    ...
    def test_login_endpoint_happy_path(self, mock_login, mock_authenticate_user):
        mock_user_instance = User(id=self.mock_user_id, email=self.login_payload["email"])
    ...
    def test_refresh_token_endpoint_happy_path(self, mock_refresh_token):
        expected_refresh_payload = {"access_token": "new.mocked.access_token", "token_type": "Bearer"}
